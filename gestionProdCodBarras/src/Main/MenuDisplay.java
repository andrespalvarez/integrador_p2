...
public class MenuDisplay {
    ...
    public static void mostrarMenuPrincipal() {
        System.out.println("\n========= MENU =========");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("1. Crear persona");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("2. Listar personas");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("3. Actualizar persona");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("4. Eliminar persona");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("5. Crear domicilio");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("6. Listar domicilios");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("7. Actualizar domicilio por ID");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("8. Eliminar domicilio por ID");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("9. Actualizar domicilio por ID de persona");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
        System.out.println("10. Eliminar domicilio por ID de persona");//****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****MODIFICAR****
